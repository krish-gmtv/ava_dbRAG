-- Small seed for Updated_schema/schema_code_v2.sql
...
INSERT INTO leads (lead_id, date_entered, assigned_user_id, status, account_id, opportunity_id)
OVERRIDING SYSTEM VALUE
VALUES
(1, '2018-03-01 10:00:00+00', 1, 'Sold to Us',         1, 1001),
(2, '2018-04-05 11:00:00+00', 2, 'Bought at Auction',  2, 1002),
(3, '2022-05-20 09:30:00+00', 2, 'Returned as Seller', 2, 2001),
(4, '2019-06-10 14:15:00+00', 3, 'Sold to Us',         3, 3001),
(5, '2020-02-15 13:00:00+00', 1, 'Open',               1, 3002),
(6, '2021-11-01 16:45:00+00', 2, 'Sold to Us',         2, 3003);
...
-- second offer on the same upsheet to exercise 1:n
