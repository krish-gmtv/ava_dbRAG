...
def build_chunk_text(
    ...
    # Optional extra detail sentence using actual KPI values
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Generate buyer-quarter level semantic chunks from the quarterly KPI CSV."
        )
    )
    parser.add_argument(
        "--input",
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="KPIs/large_seed_res/buyer_quarterly_chunks.csv",
